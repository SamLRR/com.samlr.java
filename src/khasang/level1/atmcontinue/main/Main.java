...
public class Main {
    ...
    public static void doSmth() {
        ...
        Bank.getClientInfo(client2);//Информация по клиенту
        Bank.getAccountInfo(account11);//Информация по счету(не реализовано)
//        atm.ejectCard();//вынуть карту из банкомата
    }
}
